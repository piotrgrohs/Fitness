    ...
    <View testID="ExerciseDoScreen" style={FULL}>
      ...
      <Screen style={CONTAINER} preset="scroll" backgroundColor={color.transparent}>
        ...
        textStyle={CONTINUE_TEXT}
         onPress={() => increse_reps()} text="+" />
        <TextInput
          onChangeText={test => setReps(test)}
          value={reps} style={CONTENT} placeholderTextColor="#e0e0e0"
        />
         <Button style={CONTINUE}
        textStyle={CONTINUE_TEXT}
         onPress={() => decrese_reps()} text="-" />
        <Text style={MARGIN}/> 
        <Text style={CONTENT}>Sets</Text>      
        <Button style={CONTINUE}
        textStyle={CONTINUE_TEXT}
         onPress={() => increse_sets()} text="+" />
        <TextInput
          onChangeText={text => setSets(text)} 
          value={sets} style={CONTENT} placeholderTextColor="#e0e0e0"
        />
         <Button style={CONTINUE}
        textStyle={CONTINUE_TEXT}
         onPress={() => decrese_sets()} text="-" />
      </Screen>
      ...
      <SafeAreaView style={FOOTER}>
        ...
        <Button style={CANCEL}
           textStyle={CONTINUE_TEXT}
            onPress={() => cancel()} text="CANCEL" />

          <Button style={COMPLETE}
           textStyle={CONTINUE_TEXT}
            onPress={() => complete()} text="COMPLETE" />
        </View>
      </SafeAreaView>
    </View>
  )
